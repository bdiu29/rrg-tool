...
FIELDS = {
    ...
    "ad_rating":          {"label": "Accum/Distrib (A-E)", "kind": "str"},
    "market_cap":         {"label": "Market cap",        "kind": "num"},
    "shares_outstanding": {"label": "Shares outstanding", "kind": "num"},
    "eps_growth_q":       {"label": "EPS growth, quarterly YoY (frac)", "kind": "num"},
    "eps_growth_a":       {"label": "EPS/Rev growth, annual (frac)", "kind": "num"},
